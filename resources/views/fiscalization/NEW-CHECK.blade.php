      ...
      <div class="container">
        <main>
          <section class="top">
			...
			<button type="button" id="">ПОСТ 1</button>
			<button type="button" id="">ПОСТ 2</button>
			<button type="button" id="">ПОСТ 3</button>
			<button type="button" id="">ПОСТ 4</button>
	            </div>
